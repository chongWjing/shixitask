<template>
  <div class="shop-home">
    <!-- ==================== 2. 轮播图区域（搜索时隐藏） ==================== -->
    <div v-if="!keyword" class="banner-section full-width">
      <el-carousel
        :interval="5000"
        height="420px"
    ...
    <!-- ==================== 5. 鲜花推荐区（搜索时隐藏） ==================== -->
    <div v-if="!keyword" class="recommend-section centered">
    ...
    <div class="product-section centered">
      <div class="section-title-row">
        <div class="section-title-row__left">
          <h2 class="section-main-title">{{ sectionTitle }}</h2>
          <p class="section-main-sub">{{ sectionSub }}</p>
        </div>
      </div>
    ...
    <!-- ==================== 7. 晒单评价区（搜索时隐藏） ==================== -->
    <div v-if="!keyword" class="review-section centered">
      <div class="section-title-row">
        <div class="section-title-row__left">
...
export default {
  ...
  computed: {
    ...
    sectionSub() {
      if (this.keyword) return '根据关键词匹配的商品'
      if (this.activeCategory) return this.activeCategory + ' — 精选优质，新鲜直达'
      return '精选优质鲜花，新鲜直达'
    }
  },
